...
public class BankResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createBank(@Argument Bank input) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateBank(@Argument UUID id, @Argument Bank input) {
        try {
