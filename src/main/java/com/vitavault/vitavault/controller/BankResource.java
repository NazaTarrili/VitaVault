...
public class BankResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createBank(@Argument Bank entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateBank(@Argument UUID id, @Argument Bank entity) {
        try {
