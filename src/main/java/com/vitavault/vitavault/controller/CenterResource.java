...
public class CenterResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createCenter(@Argument Center entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateCenter(@Argument UUID id, @Argument Center entity) {
        try {
