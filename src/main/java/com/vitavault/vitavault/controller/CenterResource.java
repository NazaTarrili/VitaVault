...
public class CenterResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createCenter(@Argument Center input) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateCenter(@Argument UUID id, @Argument Center input) {
        try {
