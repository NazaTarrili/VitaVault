...
@CrossOrigin(origins = "*")
public class DeliveryNoteResource implements IBaseController<DeliveryNote> {
    @Autowired
    ...
    @Override
    @PostMapping
    public ResponseEntity<ResponseFormatter> create(@RequestBody DeliveryNote entity) {
        try {
    ...
    @Override
    @PutMapping("/{id}")
    public ResponseEntity<ResponseFormatter> update(@PathVariable UUID id, @RequestBody DeliveryNote entity) {
        try {
