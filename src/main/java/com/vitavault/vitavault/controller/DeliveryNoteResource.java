...
public class DeliveryNoteResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createDeliveryNote(@Argument DeliveryNote entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateDeliveryNote(@Argument UUID id, @Argument DeliveryNote entity) {
        try {
