...
public class DetailStatusResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createDetailStatus(@Argument DetailStatus input) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateDetailStatus(@Argument UUID id, @Argument DetailStatus input) {
        try {
