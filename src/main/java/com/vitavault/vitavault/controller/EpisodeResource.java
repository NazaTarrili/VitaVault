...
public class EpisodeResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createEpisode(@Argument Episode entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateEpisode(@Argument UUID id, @Argument Episode entity) {
        try {
