...
public class PatientResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createPatient(@Argument Patient entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updatePatient(@Argument UUID id, @Argument Patient entity) {
        try {
