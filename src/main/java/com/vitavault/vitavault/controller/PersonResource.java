...
public class PersonResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createPerson(@Argument Person input) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updatePerson(@Argument UUID id, @Argument Person input) {
        try {
