...
public class PlanResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createPlan(@Argument Plan entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updatePlan(@Argument UUID id, @Argument Plan entity) {
        try {
