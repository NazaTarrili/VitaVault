...
public class PlanResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createPlan(@Argument Plan input) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updatePlan(@Argument UUID id, @Argument Plan input) {
        try {
