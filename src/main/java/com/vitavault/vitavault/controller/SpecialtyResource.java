...
@CrossOrigin(origins = "*")
public class SpecialtyResource implements IBaseController<Specialty> {
    @Autowired
    ...
    @Override
    @PostMapping
    public ResponseEntity<ResponseFormatter> create(@RequestBody Specialty entity) {
        try {
    ...
    @Override
    @PutMapping("/{id}")
    public ResponseEntity<ResponseFormatter> update(@PathVariable UUID id, @RequestBody Specialty entity) {
        try {
