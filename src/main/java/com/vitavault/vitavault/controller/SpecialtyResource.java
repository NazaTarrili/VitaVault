...
public class SpecialtyResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createSpecialty(@Argument Specialty entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateSpecialty(@Argument UUID id, @Argument Specialty entity) {
        try {
