...
public class StateResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createState(@Argument State entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateState(@Argument UUID id, @Argument State entity) {
        try {
