...
public class UserResource {
    ...
    //Mutations
    @MutationMapping
    public ResponseEntity<ResponseFormatter> createUser(@Argument User entity) {
        try {
    ...
    @MutationMapping
    public ResponseEntity<ResponseFormatter> updateUser(@Argument UUID id, @Argument User entity) {
        try {
